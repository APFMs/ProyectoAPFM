      ...
      <form method="POST" action="recibCliente.php">
        ...
        <div class="modal-body" id="cont_modal">
          ...
          <div class="col-md-12 mt-2">
            ...
            <input type="text" class="form-control" name="acercaDe" required='true'>
          </div>

        </div>
        <div class="modal-footer">
          <button type="button" class="btn btn-secondary" data-dismiss="modal">Cerrar</button>
          <button type="submit" class="btn btn-primary">Guardar Fundación</button>
        </div>
      </form>
...
<div class="modal fade" id="insert1Childresn<?php echo $dataCliente['id']; ?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header" style="background-color: #f39c12 !important;">
        <h6 class="modal-title" style="color: #fff; text-align: center;">
      ...
      <form method="POST" action="recibCliente1.php">
