      ...
      <div class="container-fluid mt-1 p-5">
        ...
        <form method="POST" action="reporteAdopciones.php">
          ...
          <div class="row align-items-end mb-3">
            <div class="col-sm">
              <label for="startdate_datepicker"><strong style="color:#ec4c4c;">Fecha de Adopción:</strong></label>
        ...
        <div class="row text-center" style="background-color: #ffc66c">
          <div class="col-md-11">
            <strong style="color:#ec4c4c; font-size: 21px">Reporte de adopciones <span style="color: crimson"> ( <?php echo $cantidad; ?> )</span> </strong>
          </div>
        </div>
                    ...
                    <div class="col-md-12 p-2">
                      <div class="table-responsive">
                        <table class="table table-bordered table-striped table-hover">
                          <thead>
                            <tr>
                              <th style="color:#0e2fa7" scope="col">Nombre Adoptante</th>
                              <th style="color:#0e2fa7" scope="col">Carnet de Identidad</th>
                              <th style="color:#0e2fa7" scope="col">Sexo del Adoptante</th>
                              <th style="color:#0e2fa7" scope="col">Fecha de Nacimiento</th>
                              <th style="color:#0e2fa7" scope="col">Celular</th>
                              <th style="color:#0e2fa7" scope="col">Dirección</th>
                              <th style="color:#0e2fa7" scope="col">Nombre de la Mascota</th>
                              <th style="color:#0e2fa7" scope="col">Especie</th>
                              <th style="color:#0e2fa7" scope="col">Sexo de la Mascota</th>
                              <th style="color:#0e2fa7" scope="col">Color</th>
                              <th style="color:#0e2fa7" scope="col">Fecha de Adopción</th>
