        ...
        <label type="hidden" name="id" value="<?php echo $dataCliente['id']; ?>">
          ...
          <div class="modal-body" id="cont_modal">
            <div class="form-group" id="izquierda">
              ...
              <br>
              <label style="color:#ec4c4c;" for="">Especie:</label> <label style="color:#115293;"><?php echo $dataCliente['especie']; ?></label>
              <br>
              <label style="color:#ec4c4c;" for="celular" class="form-label">Edad: </label> <label style="color:#115293;"><?php echo $dataCliente['edad']; ?></label>
              <br>
              <label style="color:#ec4c4c;" for="">Sexo: </label> <label style="color:#115293;"><?php echo $dataCliente['sexo']; ?></label>
              <br>
              <label style="color:#ec4c4c;" for="">Color: </label> <label style="color:#115293;"><?php echo $dataCliente['color']; ?></label>
              <br>
              <label style="color:#ec4c4c;" for="">Tamaño: </label> <label style="color:#115293;"><?php echo $dataCliente['tam']; ?></label>
              <br>
              <label style="color:#ec4c4c;" for="">Descripción: </label> <label style="color:#115293;"><?php echo $dataCliente['descripcion']; ?></label>
            </div>
