    ...
    <div class="wrapper">
        ...
        <nav class="main-header navbar navbar-expand navbar-white navbar-light">
            ...
            <ul class="navbar-nav ml-auto">
                <!-- Navbar Search -->
                <li class="nav-item">
                    <a class="nav-link" data-widget="navbar-search" href="tablaAdministrador.php" role="button">
                        <i class="fas fa-search"></i>
                    </a>
                    <div class="navbar-search-block">
                        <form class="form-inline">
                            <div class="input-group input-group-sm">
                                <input class="form-control form-control-navbar" type="search" placeholder="Search" name="palabraBuscada" aria-label="Search" id="buscador">
                                <div class="input-group-append">
                                    <button class="btn btn-navbar" type="submit" name="submit" onclick="miFunc()">
                                        <i class="fas fa-search"></i>
                                    </button>
                                                    ...
                                                    <tbody>
                                                        ...
                                                        while ($dataCliente = mysqli_fetch_array($queryCliente)) { ?>
                                                            <tr>
                                                                ...
                                                                <td><?php echo $dataCliente['usuarioMod']; ?></td>
...
<strong>Fundaciones de Cochabamba &copy; 2021 <a href="index.html">SomosTuVoz</a>.</strong> Por un mundo mejor.
                ...
                $('.btnBorrar').click(function(e) {
                    ...
                    $.ajax({
                        ...
                        success: function(data) {
                            window.location.href = "tablaAdministrador.php";
                            $('#respuesta').html(data);
                        }
                    });
                    return false;
        ...
        <script>
            function miFunc() {
                ...
                $var = document.getElementById("buscador").value;
                //alert($var);
                <?php $buscar ?> = $var;
