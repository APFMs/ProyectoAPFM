  ...
  <div class="wrapper">
    ...
    <nav class="main-header navbar navbar-expand navbar-white navbar-light">
      ...
      <ul class="navbar-nav ml-auto">
        <!-- Navbar Search -->
        <li class="nav-item">
          <a class="nav-link" data-widget="navbar-search" href="Administrador.php" role="button">
                        ...
                        <table class="table table-bordered table-striped table-hover">
                          <thead>
                            <tr>
                              ...
                              <th style="color:#115293;" scope="col">Nombre de Usuario</th>
                          ...
                          <tbody>
                            ...
                            ?>
                              ...
                              <tr>
                                ...
                                <td><?php echo $dataCliente['nombreUsuario']; ?></td>
