    ...
    <div class="content-wrapper">
      ...
      <div class="container mt-1 p-1">
        ...
        <div class="row text-center" style="background-color: #ffc66c">
          ...
          <div class="col-md-11">
            <strong style="color:#ec4c4c; font-size: 21px" >Mascotas en Adopción <span style="color: crimson"> ( <?php echo $cantidad; ?> )</span> </strong>
          </div>
        </div>
                        ...
                        <table class="table table-bordered table-striped table-hover">
                          <thead>
                            <tr>
                              ...
                              <th style="color:#115293;" scope="col">Color</th>
