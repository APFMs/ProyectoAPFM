  ...
  <div class="wrapper">
    ...
    <div class="content-wrapper">
      ...
      <div class="container mt-1 p-1">
        ...
        $sqlCliente   = ("SELECT S.id, S.mascota_id, S.nombre AS 'nombreSolicitante',S.apllpat, S.apllmat, S.fechaNac, S.sexo, S.ci, S.num, S.casa, S.direccion, S.fotoCi,S.fotoLuz, S.fotoCasa, S.aprobada, M.nombre as 'nombreMascota', S.info
