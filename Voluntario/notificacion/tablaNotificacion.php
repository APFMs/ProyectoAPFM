  ...
  <div class="wrapper">
    ...
    <div class="content-wrapper">
      ...
      <div class="container mt-1 p-1">
        ...
        $sqlQuery = "SELECT S.id, S.mascota_id, S.nombre AS 'nombreSolicitante', S.apllpat, S.apllmat, S.fechaNac, S.sexo, S.ci, S.num, S.depa, S.casa, 
        ...
        <div class="row text-center" style="background-color: #ffc66c">
          ...
          <div class="col-md-11">
            <strong style="color:#ec4c4c; font-size: 21px" >Notificación <span style="color: crimson"> ( <?php echo $cantidad; ?> )</span> </strong>
          </div>
        </div>
